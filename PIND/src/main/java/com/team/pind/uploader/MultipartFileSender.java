package com.team.pind.uploader;
...
public class MultipartFileSender {
    ...
    public void serveResource() throws Exception {
        ...
        long lastModified = LocalDateTime.ofInstant(lastModifiedObj.toInstant(), ZoneId.of(ZoneId.systemDefault().getId())).toEpochSecond(ZoneOffset.UTC);
