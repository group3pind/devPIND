...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">ㅇㅇㅇㅇ</a>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      ...
      <p><img class="photo" src="../resources/image/profileimg.jpg" /></p>
      <p class="lead"></p>
      <a href="#" class="btn btn-primary btn-lg"  style="background-color: #78C2AD;">Edit Profile</a>
